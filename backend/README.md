...
## Project Structure
    ...
    ├── samplehooksandredux_31371  # Django project configurations
...
1. Clone this repo and `cd samplehooksandredux_31371`
...
2. Clone this repo and `cd samplehooksandredux_31371`
